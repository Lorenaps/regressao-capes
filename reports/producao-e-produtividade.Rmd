...
Produtividade = -0,1.mestrados + 0,03.doutorados + 0,20.mestrados_pprof explicam 35,87% da variância da variável de resposta. Mestrados, é medida como a contagem de dissertações em um programa durante 3 anos, tem uma relação negativa com Produtividade (b = [-0,0215; 0,0002], IC com 95%), assim como Doutorados medida como a contagem de teses em um programa durante 3 anos (b = [0,0128; 0,0486], IC com 95%) e como Mestrados_pprof medida como a taxa de alunos de mestrado por docente permanente durante 3 anos (b = [-0,0976; 0,5020], IC com 95%).
